		...
		<div class="row" id="cabezote">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				...
				<a href="#">
					...
					<img src="http://localhost:81/backend/vistas/img/plantilla/logo.png" class="img-responsive">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<p>TU CESTA <span class="cantidadCesta">3</span> <br> USD $ <span class="sumaCesta">600</span></p>	
